...
import com.example.contactapproom.adapter.ContactsAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addAndEditContacts(final boolean isUpdated,final Contact contact,final int position) {
        ...
        View view = layoutInflater.inflate(R.layout.layout_add_item,null);
        ...
        alerDialogBuilder.setCancelable(false)
                .setPositiveButton(isUpdated ? "Update" : "Save", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //addAndEditContacts(true, null, -1);
                        Toast.makeText(MainActivity.this, "Oressed", Toast.LENGTH_SHORT).show();
                    }
                })
